...
<script type="text/javascript">
    $(function() {
        ...
        var initparams01 = {
            "ajax" : {
                "url" : "${r'${pageContext.request.contextPath}'}/${Constant.REQUEST_MODEL_BASE}/${entity.nameNoSuffix?lower_case}/list",
                "type" : "POST",
                "data" : function(d) {
                    var orders = d.order;
                    console.log(orders);
            ...
            "aoColumns" : [
                <#list entity.properties as property>
                	{"data" : "${property.propertyName}", "sClass" : "text-center" }
                </#list>
            ],
            "aoColumnDefs" : []
        };
      ...
      //机构选择框
        ...
        $("#downbutton").click(function() {
            ...
            if (tableRowsCount && tableRowsCount != undefined && tableRowsCount > 0) {
                ...
                var url = "${r'${pageContext.request.contextPath}'}/${Constant.REQUEST_MODEL_BASE}/${entity.nameNoSuffix?lower_case}/download";
